  ...
  return (
    <>
      ...
      <section className="overflow-hidden relative mt-0 pt-[10px] pb-10 lg:pt-20 xl:pt-28 bg-white">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-6 2xl:px-0">
          <div className="flex gap-7.5">
            ...
            <div className="w-full">
              <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p>
                      Menampilkan <span className="text-dark">{products.length}</span>{" "}
                      Produk
                    </p>
                  </div>
              ...
              <div
                className={`${
                  productStyle === "grid"
                    ? "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-x-7.5 gap-y-9"
