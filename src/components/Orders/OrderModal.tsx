...
const OrderModal = ({ showDetails, showEdit, toggleModal, order }: any) => {
  ...
  return (
    <>
      ...
      >
        <div className="shadow-7 relative w-full max-w-[600px] h-auto scale-100 transform rounded-[15px] bg-white transition-all p-6 sm:p-8 flex flex-col">
          <button
          ...
          <>
            {showDetails && <OrderDetails orderItem={order} toggleModal={toggleModal} />}
