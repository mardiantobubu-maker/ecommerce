  ...
  return (
    <div className="mt-9">
      ...
      <div className="bg-white shadow-1 rounded-[10px] p-4 sm:p-8.5">
        ...
        <div className="mb-5">
          <label htmlFor="billing-companyName" className="block mb-2.5">
            Nama Perusahaan
          </label>
        ...
        <div className="mb-5">
          <label htmlFor="billing-countryName" className="block mb-2.5">
            Negara/ Wilayah
        ...
        <div className="mb-5">
          ...
          <div className="mt-5">
            <input
              type="text"
              name="address"
              id="billing-addressTwo"
              placeholder="Apartemen, suite, unit, dll. (opsional)"
              className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
            />
          </div>
        </div>
        ...
        <div className="mb-5">
          <label htmlFor="billing-town" className="block mb-2.5">
        ...
        <div className="mb-5">
          <label htmlFor="billing-phone" className="block mb-2.5">
            Telepon <span className="text-red">*</span>
          </label>
