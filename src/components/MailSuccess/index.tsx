...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"Pesan Terkirim"} pages={["Pesan Terkirim"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Terima kasih banyak atas pesan Anda. Kami memeriksa email secara berkala
                dan akan berusaha sebaik mungkin untuk menanggapi pertanyaan Anda.
              </p>
