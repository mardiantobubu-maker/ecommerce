              ...
              <div className="flex items-center justify-between w-full sm:w-auto sm:flex-shrink-0 lg:w-auto">
                ...
                <div className="flex items-center gap-5 lg:hidden pr-3">
                  <button
                    ...
                    className="relative flex items-center justify-center w-12 h-12 rounded-full bg-gray-2 transition-all hover:bg-blue/10 group"
                  >
                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-dark-4 group-hover:text-blue transition-colors">
                  ...
                  >
                    <span className="block relative cursor-pointer w-5.5 h-5">
