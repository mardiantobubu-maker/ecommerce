...
import '@/app/css/range-slider.css';

const PriceDropdown = ({ priceRange, setPriceRange }) => {
  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <p className="text-[12px] font-black uppercase text-[#212121] tracking-widest">Harga</p>
        <button
          onClick={(e) => {
            e.stopPropagation();
            ...
            <div className="price-amount flex items-center justify-between pt-4">
              <div className="text-custom-xs text-dark-4 flex rounded border border-gray-3/80">
                ...
                <span id="minAmount" className="block px-3 py-1.5">
                  {priceRange.from.toLocaleString('id-ID')}
                </span>
              </div>
              ...
              <div className="text-custom-xs text-dark-4 flex rounded border border-gray-3/80">
                ...
                <span id="maxAmount" className="block px-3 py-1.5">
                  {priceRange.to.toLocaleString('id-ID')}
                </span>
              </div>
            </div>
          </div>
