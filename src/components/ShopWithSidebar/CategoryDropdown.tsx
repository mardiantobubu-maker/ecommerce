...
const CategoryItem = ({ category, isSelected, toggleCategory }) => {
  return (
    <button
      className={`${
...
const CategoryDropdown = ({ categories, selectedCategories, setSelectedCategories }) => {
  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <p className="text-[12px] font-black uppercase text-[#212121] tracking-widest">Kategori</p>
        <button
      ...
      >
        {categories.map((category, key) => (
          <CategoryItem 
            ...
            toggleCategory={() => handleToggleCategory(category.name)}
          />
        ))}
      </div>
    </div>
